...
public class ScrollerNumberPicker extends View {
     ...
     * 选中的时候字体
     */
    private float selectedFont = 15.0f;
    /**
     * 单元格高度
     */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        selectedFont = attribute.getDimension(R.styleable.NumberPicker_selecredTextSize, 16.0f);
        itemNumber = attribute.getInt(R.styleable.NumberPicker_itemNumber, 5);
