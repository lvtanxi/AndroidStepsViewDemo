...
public class StepsViewIndicator extends View {
    ...
    private static final int CIRCLERADIUS_SIZE = 100;
    ...
    private void init() {
        ...
        mThumbRadius = 0.4f * CIRCLERADIUS_SIZE;
        mCircleRadius = 0.5f * mThumbRadius;
        mPadding = 0.5f * CIRCLERADIUS_SIZE;
    }
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mThumbContainerXPosition.size(); i++) {
            ...
            canvas.drawCircle(mThumbContainerXPosition.get(i), mCenterY,(i == mCompletedPosition) ? mCircleRadius+10 : mCircleRadius, (i <= mCompletedPosition) ? selectedPaint : paint);
        }
        ...
        for (int i = 0; i < mThumbContainerXPosition.size(); i++) {
            canvas.drawCircle(mThumbContainerXPosition.get(i), mCenterY, (i == mCompletedPosition) ? mCircleRadius : mCircleRadius-5, paint2);
        }
    }
